...
//This doesn't work because subclass variables and methods only work one way with classes and subclasses; A subcalss can adapt its classes variables and methods, but not vice versa
